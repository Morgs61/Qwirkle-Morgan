...
void initializePlayerHand(LinkedList *playerHand, LinkedList *bag)
{
    ...
    {
        Tile *oldTile = bag->back();
        // Create a new Tile object with the same colour and shape as the old Tile object
        Tile *newTile = new Tile(oldTile->getColour(), oldTile->getShape());
